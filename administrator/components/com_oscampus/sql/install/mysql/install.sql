...
CREATE TABLE IF NOT EXISTS `#__oscampus_certificates` (
  ...
  `dateformat` VARCHAR(255) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `#__oscampus_courses` (
  ...
  `image` VARCHAR(255) NOT NULL COMMENT 'Thumbnail image for course',
  ...
  INDEX `idx_certificates_id` (`certificates_id` ASC))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `#__oscampus_courses_certificates`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__oscampus_courses_certificates` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `users_id` INT(11) NOT NULL COMMENT 'User FK',
  `certificates_id` INT(11) NOT NULL,
  `courses_id` INT(11) NOT NULL COMMENT 'Course FK',
