...
trait OscampusControllerTraitBase
{
    /**
     * @var CMSApplication
     */
     ...
     * @throws Exception
     */
    protected function initOscampus(array $config)
    {
        $this->app = OscampusFactory::getApplication();

        $this->container = isset($config['container']) && $config['container'] instanceof Container
            ? $config['container']
     ...
     * @return void
     */
    protected function errorReturn(string $message, $type = 'error')
    {
